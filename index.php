...
<head>
  ...
  <meta name="application-name" content="Web-studio F&S">
  <meta name="apple-mobile-web-app-title" content="Web-studio F&S">
  <meta name="theme-color" content="#5e2ced">
  <meta name="msapplication-navbutton-color" content="#5e2ced">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="Веб-студия F&S">
  <meta property="og:title" content="Веб-студия F&S - разработка сайтов">
  <meta property="og:description" content="Веб-студия F&S - разработка и сопровождение сайтов в Краснодаре и по всей территории РФ">
...
<body>
          ...
          <ul class="menu inline-block">
            ...
            <li class="menu__dropdown">
              ...
              <ul class="menu submenu zIndex-9">
                ...
                <li><a href="pages/services/other/" class="link menu-link">PWA-сайты</a></li>
              </ul>
            </li>
      ...
      <div class="container zIndex-1">
        <div class="container__preview-block">
          ...
          <div class="container preview-block__right" id="parallax">
            <img src="images/rocket.png" class="image__rocket" id="rocket" />
      ...
      <div class="services">
        ...
        <div class="service-block service-block__margin wow fadeInRight">
          <div class="service__inner alignCenter">
            ...
            <h1 class="caption caption_h1">Поддержка</h1>
            <p class="text">
              Мы всегда на связи. Профессиональная консультация по любым вопросам, связанным с Вашим проектом.
            </p>
          </div>
        </div>
      </div>
  ...
  <div class="container container_promo">
    <div class="promo-block wow fadeIn">
      <h1 class="caption caption_h1 caption__promo alignCenter">Решите проблему с поиском клиентов прямо сейчас!</h1>
      <h3 class="caption caption_h3 text__promo alignCenter">Закажите продвижение сайта и рекламу в веб-студии F&S</h3>
      <div class="promo__button alignCenter">
      ...
      <div class="container">
        <div class="tab__text tab_active">
          <div class="tab__image-block">
            <img src="images/preview-image.png" class="image tab__image" />
          </div>
        ...
        <div class="tab__text">
          <div class="tab__text-block">
            ...
            <p class="text">
              ...
              <ul class="problems__list">
                <li class="problems__li"><span class="text problems__span">Предложим до двух прототипов</span></li>
        ...
        <div class="tab__text">
          ...
          <div class="tab__image-block">
            <img src="images/step-4.png" class="image tab__image" />
          </div>
        </div>
        <div class="tab__text">
          <div class="tab__image-block">
            <img src="images/step-5.png" class="image tab__image" />
          </div>
          <div class="tab__text-block">
